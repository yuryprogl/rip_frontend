...
INCLUDE_EXTENSIONS=("js" "jsx" "ts" "tsx" "css" "html" "json" "yaml" "yml" "md" "env" "cfg" "ini" "toml" "py")

# Директории, которые исключаем
EXCLUDE_DIRS=("node_modules" ".git" "venv" "env" ".cache" "build" "dist" "__pycache__" "migrations" "static" "media" ".idea" ".vscode")
